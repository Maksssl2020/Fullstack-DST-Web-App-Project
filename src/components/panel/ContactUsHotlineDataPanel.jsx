...
const ContactUsHotlineDataPanel = () => {
  return (
    <div className="w-[40%] text-white p-6 flex flex-col justify-between relative h-full bg-[#FFA5A5] rounded-3xl">
      <div className="w-[60%] font-bold flex items-center justify-center text-3xl absolute inset-0 ml-auto h-[85px] translate-x-4 -translate-y-11 bg-custom-pink-300 rounded-full">
        +48 715
      </div>
      <h2 className="text-5xl font-bold">Infolinia</h2>
      ...
      <div className="gap-4 flex flex-col">
        <h3 className="font-bold text-xl">
          Nasz zespół jest dla ciebie dostępny:
        </h3>
        <uL className="font-bold ml-12 flex flex-col w-[55%] text-2xl list-disc marker:text-custom-red-100">
