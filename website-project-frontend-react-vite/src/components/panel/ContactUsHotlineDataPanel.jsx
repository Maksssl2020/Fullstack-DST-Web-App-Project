...
const ContactUsHotlineDataPanel = () => {
  return (
    <div className="w-[40%] text-white p-6 flex flex-col justify-between relative h-full bg-[#FFA5A5] rounded-3xl">
      <div className="w-[60%] font-bold flex items-center justify-center lg:text-xl xl:text-2xl absolute inset-0 ml-auto md:h-[65px] lg:h-[75px] xl:h-[85px] translate-x-4 -translate-y-11 bg-custom-pink-300 rounded-full">
        +48 715
      </div>
      <h2 className="md:text-lg lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold">
        Infolinia
      </h2>
